...
(cl:defmethod cl:initialize-instance :after ((m <PublishMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PublishMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<PublishMap-request> is deprecated: use map_store-srv:PublishMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <PublishMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PublishMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<PublishMap-response> is deprecated: use map_store-srv:PublishMap-response instead.")))
