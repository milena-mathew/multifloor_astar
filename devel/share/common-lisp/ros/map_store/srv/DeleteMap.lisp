...
(cl:defmethod cl:initialize-instance :after ((m <DeleteMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeleteMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<DeleteMap-request> is deprecated: use map_store-srv:DeleteMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <DeleteMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeleteMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<DeleteMap-response> is deprecated: use map_store-srv:DeleteMap-response instead.")))
