...
(cl:defmethod cl:initialize-instance :after ((m <RenameMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RenameMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<RenameMap-request> is deprecated: use map_store-srv:RenameMap-request instead.")))
...
(cl:defmethod new_name-val ((m <RenameMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store-srv:new_name-val is deprecated.  Use map_store-srv:new_name instead.")
  (new_name m))
...
(cl:defmethod cl:initialize-instance :after ((m <RenameMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RenameMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store-srv:<RenameMap-response> is deprecated: use map_store-srv:RenameMap-response instead.")))
