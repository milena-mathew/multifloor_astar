...
if("TRUE" STREQUAL "TRUE")
  set(map_store_SOURCE_PREFIX /home/mathewmilena/multifloor_astar/src/map_store)
  set(map_store_DEVEL_PREFIX /home/mathewmilena/multifloor_astar/devel)
  ...
  set(map_store_INSTALL_PREFIX /home/mathewmilena/multifloor_astar/install)
...
if(NOT "/home/mathewmilena/multifloor_astar/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/map_store " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/map_store' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_store' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mathewmilena/multifloor_astar/src/map_store/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT map_store_NUM_DUMMY_TARGETS)
      set(map_store_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::map_store::wrapped-linker-option${map_store_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR map_store_NUM_DUMMY_TARGETS "${map_store_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::map_store::wrapped-linker-option${map_store_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND map_store_LIBRARIES "${interface_target_name}")
