...
"""autogenerated by genpy from multi_map_navigation/MultiMapNavigationGoal.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavigationGoal(genpy.Message):
  _md5sum = "47922f5c2738d0955979038029fc03b5"
  _type = "multi_map_navigation/MultiMapNavigationGoal"
...
float64 w
"""
  __slots__ = ['target_pose','goal_map']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal_map = str[start:end]
      return self
