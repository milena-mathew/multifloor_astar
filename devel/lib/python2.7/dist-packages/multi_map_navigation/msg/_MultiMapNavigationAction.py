...
"""autogenerated by genpy from multi_map_navigation/MultiMapNavigationAction.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavigationAction(genpy.Message):
  _md5sum = "c9a9448d7a71de10ce67492ab75c0af1"
  _type = "multi_map_navigation/MultiMapNavigationAction"
...
"""
  ...
  _slot_types = ['multi_map_navigation/MultiMapNavigationActionGoal','multi_map_navigation/MultiMapNavigationActionResult','multi_map_navigation/MultiMapNavigationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = multi_map_navigation.msg.MultiMapNavigationActionGoal()
      if self.action_result is None:
        self.action_result = multi_map_navigation.msg.MultiMapNavigationActionResult()
      if self.action_feedback is None:
        self.action_feedback = multi_map_navigation.msg.MultiMapNavigationActionFeedback()
    else:
      self.action_goal = multi_map_navigation.msg.MultiMapNavigationActionGoal()
      self.action_result = multi_map_navigation.msg.MultiMapNavigationActionResult()
      self.action_feedback = multi_map_navigation.msg.MultiMapNavigationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.goal_map
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.action_feedback.feedback.current_map
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goal_map = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.current_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.current_map = str[start:end]
      return self
