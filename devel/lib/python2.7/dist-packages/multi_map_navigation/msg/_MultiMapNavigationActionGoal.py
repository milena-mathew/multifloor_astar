...
"""autogenerated by genpy from multi_map_navigation/MultiMapNavigationActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavigationActionGoal(genpy.Message):
  _md5sum = "4c63433b29817543c5cb18f657eef9a2"
  _type = "multi_map_navigation/MultiMapNavigationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','multi_map_navigation/MultiMapNavigationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = multi_map_navigation.msg.MultiMapNavigationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = multi_map_navigation.msg.MultiMapNavigationGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.goal_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.goal_map = str[start:end]
      return self
